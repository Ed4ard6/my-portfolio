  ...
  <form method="POST" action="/projects/update" style="margin-top:14px;">
    ...
    <div class="form-grid-two">
      <div style="margin-top:12px;">
        ...
        <input class="card card-pad" style="width:100%; padding:10px 12px; border-radius:12px;" type="text" name="name" required value="<?= htmlspecialchars($project['name']) ?>">
      </div>

      <div style="margin-top:12px;">
        <label class="muted">Estado del proyecto</label><br>
        <select class="card card-pad" style="width:100%; padding:10px 12px; border-radius:12px;" name="status" required>
      ...
      <div class="form-grid-span" style="margin-top:12px;">
        <label class="muted">Descripción</label><br>
        <textarea class="card card-pad" style="width:100%; padding:10px 12px; border-radius:12px; min-height:110px;" name="description" rows="4" required><?= htmlspecialchars($project['description'] ?? '') ?></textarea>
      </div>

      <div class="form-grid-span" style="margin-top:12px;">
        <label class="muted">URL del proyecto (opcional)</label><br>
        <input class="card card-pad" style="width:100%; padding:10px 12px; border-radius:12px;" type="text" name="project_url" inputmode="url" spellcheck="false" placeholder="https://... o /hangman" value="<?= htmlspecialchars($project['project_url'] ?? '') ?>">
